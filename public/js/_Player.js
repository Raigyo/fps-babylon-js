...
Player.prototype = {
  ...
  playerDead : function() {
    ...
    //When player is dead, change camera to ArcRotateCamera
    //This camera always points towards a given target position 
    //and can be rotated around that target with the target as the centre of rotation. 
    //The position is the player position.
